...
function wpm_custom_post_type() {
	...
	$labels = array(
		// Le nom au pluriel
		'name'                => _x( 'Custom bitch', 'Post Type General Name'),
		// Le nom au singulier
		'singular_name'       => _x( 'Custom bitch', 'Post Type Singular Name'),
		// Le libellé affiché dans le menu
		'menu_name'           => __( 'Custom bitch'),
		// Les différents libellés de l'administration
		'all_items'           => __( 'my Customs'),
	...
	$args = array(
		...
		*/
		...
		'public'              => true,
		'has_archive'         => true,
		'rewrite'			  => array( 'slug' => 'custom bitch'),

	);

	// On enregistre notre custom post type qu'on nomme ici "serietv" et ses arguments
	register_post_type( 'customBitch', $args );
